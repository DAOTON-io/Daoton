...
export default function CreateContract() {
  ...
  const createProposal = async () => {
    ...
    let contractAddressNew =
      '0:' + TonWeb.utils.bytesToHex(await state_init.hash());
    ...
    tonConnectUi.sendTransaction(defaultTx2).then(res => {
      ...
      axios
        .post(
          'https://0xfb5f6301747772afa27c55100b95eb29f07dbeb5.diode.link/auth',
          {address: contractAddressNew},
        )
        .then(res => {
      ...
      axios
        .post(
          'https://0xfb5f6301747772afa27c55100b95eb29f07dbeb5.diode.link/saveContract',
          {
            ...
            contract_address: contractAddressNew,
            contract_description: proposalText,
            DAO_Id: daoId,
          },
        ...
        <div style={{marginTop: '1rem'}}>
          <Card className={classes.card}>
            ...
            <Button
              ...
              style={{backgroundColor: '#2D6495', width: '35vh'}}>
              Create
            </Button>{' '}
          </Card>
        </div>
