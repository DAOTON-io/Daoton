...
const SideMenu: React.FC = () => {
  ...
  return (
    <Card className={classes.card}>
      <GoogleFontLoader
        fonts={[{font: 'Signika Negative', weights: [400, '400i']}]}
      ...
      <Stack className={classes.menuStack}>
        <List>
          <ListItemButton
            className={
              activePage.startsWith('/view-dao') || activePage === '/'
          ...
          <ListItemButton
            className={
              activePage.startsWith('/create-dao')
                ? classes.selectedItem
                : classes.item
            }
          ...
          <ListItemButton
            className={
              activePage.startsWith('/view-tokens')
                ? classes.selectedItem
                : classes.item
            }
          ...
          <ListItemButton
            className={
              activePage.startsWith('/generate-token')
                ? classes.selectedItem
                : classes.item
            }
          ...
          <ListItemButton
            className={
              activePage.startsWith('/view-nfts')
                ? classes.selectedItem
                : classes.item
            }
          ...
          <Link
            className={classes.link}
            to={
              'https://drive.google.com/file/d/1BhY6hriK72TEqH2ytaNl2ny_8Tgwna1g/view?usp=sharing'
            }
            target="_blank"
            rel="noreferrer">
            <ListItemButton
