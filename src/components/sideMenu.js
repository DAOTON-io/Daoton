                ...
                <Grid item md={12}>
                    ...
                    <div className={classes.listItem}>
                        ...
                        <Grid className={classes.listItemSmall} container spacing={1}>
                            ...
                            <Grid item>
                                <Typography >
                                    <a className={classes.item} href="view-dao" >View Dao</a>
                                </Typography>
                            </Grid>
                        </Grid>
                        ...
                        <Grid className={classes.listItemSmall} container spacing={1}>
                            ...
                            <Grid item>
                                ...
                                <Typography className={classes.item}>
                                    <a className={classes.item} href="create-dao" >Create Dao</a>
                                </Typography>
                            </Grid>
                        </Grid>  </div>
                    ...
                    <div className={classes.listItem}>
                        ...
                        <Grid className={classes.listItemSmall} container spacing={1}>
                            ...
                            <Grid item>
                                <Typography className={classes.item} >
                                    <a className={classes.item} href="view-tokens"> {" "} View Tokens</a>
